  ...
  return (
    <div className='max-w-7xl mx-auto my-10 px-4'>
      <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3'>
        ...
        disabled={isApplied} className={`rounded-lg ${isApplied ? 'bg-gray-600 cursor-not-allowed' : 'bg-[#7209b7] hover:bg-purple-800'}`}>{isApplied ? 'Already Applied' : 'Apply Now'}</Button>
      </div>
      ...
      <div className='my-4'>
        ...
        <h1 className='font-bold my-1'>Description :<span className='pl-2 font-normal text-gray-800 whitespace-pre-line'>{singleJob?.description}</span></h1>
