...
const Signup = () => {      // Signup Component
    ...
    return (        // Component UI
        ...
        <div className="min-h-screen bg-gradient-to-br from-[#edf2f7] to-[#fdf6f0]">
      <Navbar />
      <div className="flex items-center justify-center px-4">
        <motion.form
          ...
          className="w-full sm:w-[90%] md:w-2/3 lg:w-1/2 bg-white shadow-2xl rounded-2xl p-8 mt-12"
        >
          ...
          <div className="mb-4 relative">
            ...
            <Input
              ...
              onChange={changeEventHandler}
              placeholder="••••••••"
              className="hover:border-purple-500 pr-10"
            />
            <div
